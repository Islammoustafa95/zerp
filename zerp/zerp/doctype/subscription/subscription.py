...
def cancel_subscription(subscription_name):
    ...
    try:
        ...
        if not subscription.is_site_created or not subscription.site_url:
            return {
                "success": False,
        ...
        site_name = subscription.site_url.replace("https://", "").replace("http://", "")
        
        # Log the cancellation attempt
        frappe.log_error(
            message=f"Starting site deletion for subscription {subscription_name}",
